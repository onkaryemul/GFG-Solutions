...
class Solution {
    ...
    public static int maxOccured(int n, int l[], int r[], int maxx) {
        ...
        // Increment start of range and decrement the element after end of range
        for(int i=0; i < n; i++) {
            arr[l[i]]++;
            arr[r[i]+1]--;
        }
        
        // Calculate the prefix sum to get the count of occurrences
        int sum = 0;
        ...
        // Determine the maximum occurred integer
        int ans = 0;
